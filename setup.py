...
setup(
  ...
  entry_points = {'console_scripts': [
    'writeup=writeup.__main__:main',
    'html-check=writeup.html_check:main',
    'html-esc=writeup.html_esc:main',
    'html-extract=writeup.html_extract:main',
    'html-view=writeup.html_view:main',
  ]},
  keywords=[
